...
namespace TinTucNews.Controllers
{
    public class NewController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Id_Category,UrlImage,Content")] New @new)
        {
            if (id != @new.Id)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction(nameof(Index)).WithSuccess("Thông báo", "Cập nhật bài báo thành công!");
            }
            return View(@new);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index)).WithSuccess("Thông báo", "Xoá bài báo thành công!");
        }
